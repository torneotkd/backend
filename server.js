...
// REEMPLAZAR completamente el endpoint app.get('/api/dashboard/sensor-data') con esta versión corregida:
...
// AGREGAR este endpoint corregido en server.js para debugging:
